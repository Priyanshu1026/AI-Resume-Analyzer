            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-8 lg:space-y-0">
                ...
                <div className="flex flex-col space-y-4">
                    ...
                    <div className="flex space-x-4">
                        <Link href="instagram.com/priyanshu_.26" className="group p-2 rounded-lg bg-gray-800/50 hover:bg-purple-600/20 transition-all duration-300 hover:scale-110">
                        ...
                        <Link href="github.com/priyanshu1026" className="group p-2 rounded-lg bg-gray-800/50 hover:bg-emerald-600/20 transition-all duration-300 hover:scale-110">
